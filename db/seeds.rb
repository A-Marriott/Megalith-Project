...
photo = TripPhoto.new(trip: trip)
photo.photo.attach(io: maiden_img_file, filename: "lith.jpg", content_type: 'image/png')
photo.save
...
photo = TripPhoto.new(trip: trip)
photo.photo.attach(io: clandon_img_file, filename: "lith.jpg", content_type: 'image/png')
photo.save
