...
const displayPreview = (input) => {
  if (input.files) {
    ...
    for (const [key, value] of Object.entries(input.files)) {
      ...
      reader.onload = (event) => {
        document.querySelector('.photo_insert').insertAdjacentHTML('beforeend', `<img src="" class="hidden" width="100" height="100" style="margin-right: 10px; margin-bottom: 14px; object-fit: cover;">`);
